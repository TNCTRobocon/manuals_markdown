...
基本的に、表面実装部品の放熱は基板を介して行います。そのため、**如何に基板に熱を伝えるか、そして基板の熱容量・放熱性を如何に大きくするか**というのが、熱設計における肝となります。  

#### 手段1:銅箔を広くする  

基本的に基板の銅箔面積を広くすればするほど、放熱性能は高くなります。  
要は**銅箔をヒートシンクにする**っていうことですね。簡単ですが確実な効果を見込めます。  

当たり前ですが、データシートの $R_{θJA}$ よりも熱抵抗を小さくするためには、データシート上の値を測定した際の基板より大きな面積の銅箔を確保する必要があります。  
...
![thermal_via](images/2022-12-15%20153109.png)  
...
>![mask_example](images/PXL_20211203_073044425.jpg)  
