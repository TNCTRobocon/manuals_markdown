...
### ファイル作成
ファイル名や保管場所は自分に意味が通じるものにしましょう。
さっきのファイルはどこ？！消えた？！ということになりかねません。
...
ただ基本的にはしなくてよいです。
先人が作ってくれたものやネットに転がっているものもありますので、まずはgithubとネットを漁りましょう。

### フットプリント割り当て
数ある型番の中から、自分が使いたいものを選択します。
間違えると仲間に煽られるので、気を付けましょう。
部品のデータシートに書いてあることが多いので、データシートは確認しましょう。
...
抵抗やLED、リレーなどの部品を、右列の上から三番目にある、回路記号のマークのやつから取り出せます。
...
GNDや＋5V,＋3.3Vは、使用マイコンの都合上、よく使います。
...
シンボルを作ることができます。
前述した通り、基本的にすでに内蔵されていたり、ネットの海落ちていたり、先人が作っていたりするので、まずは探しましょう。
  </details>
...
ここで、表面実装にするのか、はんだパターンはどうするのか、など、部品と基板についての設計をします。
...
銅箔ですね。
基本的にはGNDはべた塗で済ませます。
そうすることによって、GNDのインピーダンスが小さくなり、ノイズの広がりを防げます。
...
（エラーや警告で配線用語がめっちゃ出てくるので、後述する資料にまとめます。）
</details>
...
また、制御班にとってわかりやすい基板デザインにするためにも、テキストはどんどん追加しましょう。
